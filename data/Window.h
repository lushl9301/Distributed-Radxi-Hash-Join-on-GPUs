...
class Window {
 ...
 public:
  ...
  Window(uint32_t numberOfNodes, uint32_t nodeId, uint32_t *assignment, uint64_t *localHistogram,
 ...
 public:
  ...
  void
  write(uint32_t partitionId, CompressedTuple *tuples, uint64_t sizeInTuples, bool flush = true);
