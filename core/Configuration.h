...
class Configuration {
 ...
 public:
  ...
  static const bool ENABLE_TWO_LEVEL_PARTITIONING = false;

  static const uint64_t NETWORK_PARTITIONING_FANOUT = 8;
  static const uint64_t LOCAL_PARTITIONING_FANOUT = 8;
